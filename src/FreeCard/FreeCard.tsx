...
export default function FreeCard() {
  ...
  return (
    <button
      ...
      className="FreeCard mt-4 xl:mt-0 relative flex items-center xl:block left-0 top-0 w-24 transition duration-200 transform hover:scale-125 active:scale-100"
    >
